...
def resnet20(pretrained=None, num_classes=10):
    return CifarResNet(BasicBlock, [3, 3, 3], num_classes)


def resnet32(pretrained=None, num_classes=10):
    return CifarResNet(BasicBlock, [5, 5, 5], num_classes)
    

def resnet44(pretrained=None, num_classes=10):
    return CifarResNet(BasicBlock, [7, 7, 7], num_classes)


def resnet56(pretrained=None, num_classes=10):
